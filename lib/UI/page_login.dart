                    ...
                    children: [
                      const Padding(
                        ...
                        child: Padding(
                          ...
                          const SizedBox(
                            height: 10),
                    const Text("QL Sinh Viên", 
                       style: TextStyle(fontSize:  50 ,fontWeight: FontWeight.bold, color: Color.fromARGB(255, 55, 230, 230)),),
                    const Text("Đăng nhập tài khoản", 
                      style: TextStyle(fontSize:  30 ,fontWeight: FontWeight.bold, color: Color.fromARGB(255, 55, 230, 230)),),
                      const SizedBox(
                        height: 20,
                      ),
                      CustomTextField(
                          ...
                          children: [
                              ...
                              GestureDetector(
                                ...
                                child: Text("Đăng ký",style:TextStyle(
                                      ...
                                      color: Color.fromARGB(255, 55, 230, 230))),
                              )
                              ],),
                          const SizedBox(height: 10,),
                          GestureDetector(
